  ...
  const mainBenefits = [
    {
      ...
      description:
        "A Gestão Contínua de Vulnerabilidades permite a identificação rápida e precisa de vulnerabilidades nos sistemas, aplicativos e infraestrutura, possibilitando uma resposta imediata para mitigar esses riscos.",
      icon: "⚡",
    ...
    },
    {
      ...
      description:
        "Ao detectar e corrigir vulnerabilidades de maneira ágil, a organização reduz significativamente o tempo em que seus sistemas estão expostos a potenciais explorações, diminuindo a janela de oportunidade para ataques.",
      icon: "⏱️",
    ...
    },
    {
      ...
      description:
        "A ferramenta de Gestão de Vulnerabilidades classifica e prioriza as vulnerabilidades com base em sua gravidade e no potencial impacto nos negócios. Isso permite que a equipe de segurança concentre seus esforços nas correções mais críticas e urgentes.",
      icon: "🎯",
    ...
    },
    {
      ...
      description:
        "A Gestão Contínua de Vulnerabilidades auxilia na manutenção da conformidade com regulamentações e padrões de segurança, fornecendo evidências das ações tomadas para mitigar riscos.",
      icon: "✅",
    ...
    },
    {
      ...
      description:
        "Ao abordar regularmente as vulnerabilidades, a organização melhora continuamente sua postura de segurança, fortalecendo as defesas contra ameaças conhecidas e emergentes.",
      icon: "🛡️",
    ...
    },
    {
      ...
      description:
        "A rápida identificação e correção de vulnerabilidades contribuem para a redução do risco de incidentes de segurança e dos custos associados à recuperação após uma violação.",
      icon: "💰",
    ...
    },
    {
      ...
      description:
        "A automação de processos na Gestão Contínua de Vulnerabilidades proporciona ganhos de eficiência, liberando a equipe de segurança para focar em tarefas mais estratégicas e na resposta a ameaças mais avançadas.",
      icon: "⚙️",
    ...
    },
    {
      ...
      description:
        "A organização desenvolve uma cultura de segurança proativa, promovendo a conscientização sobre a importância da manutenção contínua da segurança cibernética em todos os níveis da empresa.",
      icon: "🧠",
          ...
          <div className="text-center">
            ...
            >
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
                <span className="text-primary">GESTÃO ATIVA</span> DE
                VULNERABILIDADES
              </h1>
              <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
                Na vanguarda da cibersegurança, apresentamos nossa abordagem
                distintiva e compromisso inabalável em proteger seus ativos
                digitais
              </p>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-8 rounded-2xl shadow-lg">
              <p className="text-gray-700 leading-relaxed text-lg text-center">
                Nossa solução oferece a capacidade de identificar, diagnosticar
                e remediar as vulnerabilidades presentes nos seus ativos de TI,
                independentemente de serem em ambientes de nuvem, locais
                (on-premise), dispositivos endpoints, e outros. É um sistema
                completo de administração de vulnerabilidades fundamentado na
                avaliação de riscos. Tenha a tranquilidade de saber que sua
                empresa está preparada para se defender de ciberataques.
              </p>
            </div>
          </div>
        </div>
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="flex flex-col items-center mb-6">
                    <div
                      className={`w-16 h-16 bg-gradient-to-r ${step.gradient} rounded-2xl flex items-center justify-center text-2xl group-hover:scale-110 transition-transform duration-300 mb-2`}
                    >
                      {step.icon}
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto mb-8">
              O serviço de Gestão Ativa de Vulnerabilidades da SEC365 oferece
              uma abordagem pró-ativa para a segurança cibernética, resultando
              em uma postura robusta, menor exposição a ameaças e maior
      ...
      <section className="py-20 bg-gradient-to-br from-primary via-cyan-500 to-blue-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8">
            Entre em contato conosco e descubra como nossa Gestão Ativa de
            Vulnerabilidades pode fortalecer a segurança da sua organização.
          </p>
          <button
